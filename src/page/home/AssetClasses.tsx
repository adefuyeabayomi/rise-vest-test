...
function AssetClasses(): React.JSX.Element {
  return (
    <section
      id="asset-classes-section"
      className="asset-classes-container-main main-spacing-x"
    >
      <div className="py-5" />
          ...
          <div className="col-12 col-sm-10 col-lg-4">
            <div className="assets-container center">
              ...
              <div className="text-center p-2 p-sm-3">
                ...
                <p>
                  <span className="gray-text-light">Historical Return: </span>{" "}
                  14% Per Annum
                </p>
                <p>
                  <span className="gray-text-light">Risk Level: </span>Medium
                </p>
              </div>
              <div className="py-3" />
              <div className="container-fluid">
            ...
            <div className="assets-container center">
              ...
              <div className="text-center p-2 p-sm-3">
                ...
                <p>
                  ...
                  money in a secure, appreciating currency. Suitable for those
                  looking for a stable investment with returns.
                </p>
                <p>
                  <span className="gray-text-light">Historical Return: </span>{" "}
                  14% Per Annum
