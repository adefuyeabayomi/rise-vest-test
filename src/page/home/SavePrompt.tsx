...
function SavePrompt(): React.JSX.Element {
  return (
    <section id="save-prompt-section" className="save-prompt-container-main main-spacing-x">
      <div className="py-4" />
        ...
        <div className="row align-items-center g-3">
          ...
          <div className="col-12 col-lg-6 col-xl-5">
            <div className="save-prompt-texts center text-center text-lg-left">
              ...
              <h3 className="text-semibold">Save For Your <span className="color-secondary">Future</span></h3>
